  ...
  return (
    <div className="firstrun-wrap">
      <div className="firstrun">
        ...
        <p className="lede">
          Cradle is a read-only inspector for worlds generated by <b>canon</b>. Point it at a folder
          on disk that contains a <code>data/manifest.json</code> and walk its rooms, NPCs, items
          and dialogue.
        </p>
        ...
        <div className="fr-steps">
          <div className="fr-step">
            ...
            <span>
              <b>Open a world from disk</b>{" "}
              <span className="dim">— pick a folder with a canon-generated World Bible.</span>
            </span>
          </div>
          <div className="fr-step">
            <span className="num">02</span>
            <span>
              <b>Or try the bundled demo</b>{" "}
              <span className="dim">
                — <i>The Convergence of Shadows</i>, 5 rooms, fully validated.
              </span>
            </span>
          </div>
          <div className="fr-step">
